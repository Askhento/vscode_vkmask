...
//         name: 'none'
//     }),
//     numberSlider: ({ min = 0, max = 1 }: IValue) => ({
//         name: 'numberSlider',
//         min: min,
//         max: max
//     }),
//     array2d: ({ min, max } = { min : 0, max : 1 }) => ({
//         name: 'array2d',
//         min: min,
//         max: max
//     }),
//     array3d: ({ min = 0, max = 1 }: IValue) => ({
//         name: 'array3d',
//         min: min,
//         max: max
//     }),
//     array4d: ({ min = 0, max = 1 }: IValue) => ({
//         name: 'array4d',
//         min: min,
//         max: max
//     }),
...
//         name: 'tags'
//     }),
//     color: ({ min = 0, max = 1 }: IValue) => ({
//         name: 'color',
//         min: min,
//         max: max
//     }),
//     colorAlpha: ({ min = 0, max = 1 }: IValue) => ({
//         name: 'colorAlpha',
//         alpha: true,
//         min: min,
//         max: max
...
// const ZNumberSlider = z.number().describe(uiDescriptions.numberSlider({ min: 0, max: 1 }) as any);

// const ZBool = z.boolean().describe(uiDescriptions.bool() as any);
// const ZArray2D = z.number().array().length(2, { message: "Array size must be 2" }).describe(uiDescriptions.array2d() as any);
// const ZArray3D = z.number().array().length(3, { message: "Array size must be 3" }).describe(uiDescriptions.array3d() as any);
// const ZArray4D = z.number().array().length(4, { message: "Array size must be 4" }).describe(uiDescriptions.array4d() as any);
// const ZColor = z.number().array().length(3, { message: "Color size must be 3" }).describe(uiDescriptions.color({ min: 0, max: 1 }) as any );
// const ZColorAlpha = z.number().array().length(4, { message: "Color size must be 4" }).describe(uiDescriptions.colorAlpha({ min: 0, max: 1, alpha: true }) as any);
