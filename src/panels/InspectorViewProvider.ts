...
export class InspectorViewProvider implements WebviewViewProvider {

    public static readonly viewId = 'vkmask.inspector';
    ...
    private _getWebviewContent() {
        ...
        const stylesUri = getUri(this.webview, this._extensionUri, ["out", "panels", "webview-build", "inspector", "bundle.css"]);
        // The JS file from the Svelte build output
        const scriptUri = getUri(this.webview, this._extensionUri, ["out", "panels", "webview-build", "inspector", "bundle.js"]);
