...
export class AssetsManagerViewProvider implements WebviewViewProvider {

    public static readonly viewId = 'vkmask.assets_manager';
    ...
    private _getWebviewContent() {
        ...
        const stylesUri = getUri(this.webview, this._extensionUri, ["out", "panels", "webview-build", "assets_manager", "bundle.css"]);
        // The JS file from the Svelte build output
        const scriptUri = getUri(this.webview, this._extensionUri, ["out", "panels", "webview-build", "assets_manager", "bundle.js"]);
        const codiconsUri = this.webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'node_modules', '@vscode/codicons', 'dist', 'codicon.css'));
